    ...
    <div>
            ...
            <div class="relative">
                ...
                <form action="" method="" class="mb-6">
                    <div class="relative mx-auto max-w-[580px]">
                        ...
                        <button type="button" class="btn btn-gradient absolute top-1 shadow-none ltr:right-1 rtl:left-1">Search</button>
                    </div>
                </form>
        ...
        <div class="panel mt-10 text-center md:mt-20">
            ...
            <div class="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
                <button type="button" class="btn btn-gradient">Contact Us</button>
                <button type="button" class="btn btn-gradient">Visit our community</button>
            </div>
        </div>
    </div>
</template>
