                ...
                <div class="mb-5">
                    ...
                    <div class="sm:flex">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 sm:mt-7 mb-16">
                                <icon-globe class="w-5 h-5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom" />
                    ...
                    <div class="sm:flex">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-4 sm:mt-7 mb-16">
                                <icon-gallery class="text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom" />
                    ...
                    <div class="sm:flex">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-center ltr:sm:text-left rtl:sm:text-right">5 sec</p>
                            <div class="mt-4 sm:mt-7 mb-16">
                                <icon-txt-file class="w-4.5 h-4.5 text-white-dark ltr:mr-2.5 rtl:ml-2.5 inline-block align-text-bottom" />
                        ...
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                            ...
                            >
                                ...
                                <div class="p-5">
                                    ...
                                    <p><button type="button" class="btn btn-gradient">Read more</button></p>
                                </div>
                            </div>
                        </li>
                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
