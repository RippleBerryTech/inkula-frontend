                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-center">
                            <button type="button" class="btn btn-gradient" @click="showAlert(1)">Basic message</button>
                        </div>
                    </div>
                    <template v-if="codeArr.includes('code1')">
                        <highlight>
                            <pre>
&lt;!-- basic message --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-gradient&quot; @click=&quot;showAlert()&quot;&gt;Basic message&lt;/button&gt;
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-center">
                            <button type="button" class="btn btn-gradient" @click="showAlert(7)">Message timer</button>
                        </div>
                    </div>
                    <template v-if="codeArr.includes('code8')">
                        <highlight>
                            <pre>
&lt;!-- success message --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-gradient&quot; @click=&quot;showAlert()&quot;&gt;Message timer&lt;/button&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-center" id="rtl-container">
                            <button type="button" class="btn btn-gradient" @click="showAlert(14)">RTL</button>
                        </div>
                    </div>
                    <template v-if="codeArr.includes('code15')">
                        <highlight>
                            <pre>
&lt;!-- success message --&gt;
&lt;button type=&quot;button&quot; class=&quot;btn btn-gradient&quot; @click=&quot;showAlert()&quot;&gt;RTL&lt;/button&gt;
