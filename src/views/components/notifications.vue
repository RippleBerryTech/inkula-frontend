                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-center">
                            <button type="button" class="btn btn-gradient" @click="showMessage('Hello, world! This is a toast message.')">Open Toast</button>
                        </div>
                    </div>
                ...
                <div class="panel lg:row-span-2">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <button type="button" class="btn btn-gradient" @click="showMessage('Example notification text.', 'bottom')">Bottom Center</button>
                            <button
                                type="button"
                ...
                <div class="panel lg:col-span-2">
                    ...
                    <div class="mb-5">
                        <div class="grid grid-cols-2 sm:grid-cols-1 sm:flex items-center justify-center gap-2 colored-toast">
                            <div>
                                <button type="button" class="btn btn-gradient" @click="coloredToast('primary')">Primary</button>
