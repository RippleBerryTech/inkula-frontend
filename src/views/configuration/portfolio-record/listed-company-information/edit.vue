      ...
      <div class="grid xl:grid-cols-1 gap-6">
        ...
        <div class="panel">
          <div class="flex items-center justify-between mb-5">
            <h5 class="font-semibold text-lg dark:text-white-light">Edit Listed Company Information</h5>
          </div>
          <div class="mb-5">
...
useMeta({ title: 'Edit Listed Company Information' });
...
onMounted(async () => {
  ...
  const portfolioRecord = await listedCompanyInformationStore.editListedCompanyInformation(portfolioRecordId)
  ...
  if (portfolioRecord) {
    ...
    toast.error(listedCompanyInformationStore.editPortfolioRecordError || 'Listed company information not found')
  }
})
