                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex justify-center w-full gap-4">
                            <a href="javascript:;" v-tippy:anchor class="btn bg-primary btn-gradient">Link</a>
...
&lt;/script&gt;
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            <button type="button" v-tippy:hover class="btn btn-gradient">On Hover</button>
...
&lt;tippy target=&quot;noanimation&quot; animation=&quot;false&quot; trigger=&quot;click&quot;&gt;Disabled animation&lt;/tippy&gt;
                ...
                <div class="panel lg:col-span-2">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            <button type="button" v-tippy:primary class="btn btn-gradient">Primary</button>
