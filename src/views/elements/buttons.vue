                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        <div class="flex items-center justify-center w-1/2">
                            <button type="button" class="btn btn-gradient">Primary</button>
                        </div>
                        <div class="flex items-center justify-center w-1/2">
...
&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-primary&quot;&gt;Primary&lt;/button&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex w-full">
                        <div class="flex items-center justify-center w-1/2">
                            <button type="button" class="btn btn-gradient rounded-full">Primary</button>
                        </div>
                        <div class="flex items-center justify-center w-1/2">
...
&lt;button type=&quot;button&quot; class=&quot;btn btn-outline-dark&quot;&gt;Dark&lt;/button&gt;
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex flex-wrap items-center justify-center gap-2">
                        <button type="button" class="btn btn-gradient btn-lg">Primary</button>
                        <button type="button" class="btn btn-info">Info</button>
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex flex-col gap-4">
                        <button type="button" class="btn btn-gradient w-full">Button</button>
