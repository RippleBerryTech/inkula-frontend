            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                <div class="panel">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <router-link to="/users/user-account-settings" class="ltr:ml-auto rtl:mr-auto btn btn-gradient p-2 rounded-full">
                            <icon-pencil-paper />
                        </router-link>
                    </div>
                    <div class="mb-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="panel">
                    <div class="flex items-center justify-between mb-10">
                        ...
                        <a href="javascript:;" class="btn btn-gradient">Renew Now</a>
                    </div>
                    <div class="group">
