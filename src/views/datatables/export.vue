        ...
        <div class="panel pb-1.5 mt-6">
            <div class="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                <div class="flex items-center flex-wrap">
                    <button type="button" class="btn btn-gradient btn-sm m-1" @click="exportTable('csv')">
                        <icon-file class="w-5 h-5 ltr:mr-2 rtl:ml-2" />
                        CSV
                    </button>
                    <button type="button" class="btn btn-gradient btn-sm m-1" @click="exportTable('txt')">
                        <icon-file class="w-5 h-5 ltr:mr-2 rtl:ml-2" />
                        TXT
                    </button>
                    <vue3-json-excel class="btn btn-gradient btn-sm m-1 cursor-pointer" name="table.xls" :fields="excelColumns()" :json-data="excelItems()">
                        <icon-file class="w-5 h-5 ltr:mr-2 rtl:ml-2" />

                        EXCEL
                    </vue3-json-excel>
                    <button type="button" class="btn btn-gradient btn-sm m-1" @click="exportTable('print')">
