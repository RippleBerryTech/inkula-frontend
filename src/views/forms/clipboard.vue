                        ...
                        <div class="bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]">
                            <form>
                                ...
                                <div class="flex flex-wrap gap-2 mt-5">
                                    <button type="button" class="btn btn-gradient" @click="copy(message1)">
                    ...
                    <div class="mb-5">
                        <div class="bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]">
                            <form>
                                ...
                                <div class="flex flex-wrap gap-2 mt-5">
                                    <button type="button" class="btn btn-gradient" @click="copy(message2)">
                                        <icon-copy class="ltr:mr-2 rtl:ml-2" />
                                        Copy from Input
                                    </button>
                    ...
                    <div class="mb-5">
                        <div class="bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]">
                            <form>
                                ...
                                <div class="flex flex-wrap gap-2 mt-5">
                                    <button type="button" class="btn btn-gradient" @click="copy('22991')">
                                        <icon-copy class="ltr:mr-2 rtl:ml-2" />
                                        Copy from Paragraph
                                    </button>
                                </div>
                    ...
                    <div class="mb-5">
                        <div class="bg-[#f1f2f3] p-5 rounded dark:bg-[#060818]">
                            <form>
                                ...
                                <div class="flex flex-wrap gap-2 mt-5">
                                    <button type="button" class="btn btn-gradient" @click="copy('http://www.admin-dashboard.com/code')">
                                        <icon-copy class="ltr:mr-2 rtl:ml-2" />
                                        Copy Link
                                    </button>
